...
const Details=({type, time , place, info})=>{
  ...
  return <li  ref={ref} className='my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col item-center justify-between'>
    ...
    >
      <h3 className='capitalize font-bold text-2xl text-red'>
      {type}
      </h3>
      <span className='capitalize font-medium text-dark/75 dark:text-light/75'>
        {time}|{place}
      </span>
      <p className='font-medium w-full text-orange'>
        {info}
      </p>
    </motion.div>
  </li>
...
info="BOARD EXAM CLASS 10"
                />
                   <Details
type="The Central Board of Secondary Education" 
time="2020"
place="AVADH COLLEGIATE" 
info="BOARD EXAMINATION CLASS 12"
                />
                   <Details
